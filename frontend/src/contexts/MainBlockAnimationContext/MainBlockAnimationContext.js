...
import { MOST_SHORT_DELAY, SHAKE_ELEMENT_MAX_VALUE, SHAKE_ELEMENT_MIN_VALUE, SHORT_DELAY } from "../../constants";
...
export const useCreateMainBlockAnimationContext = function () {
    ...
    const shake = useCallback(() => {
        let min = SHAKE_ELEMENT_MIN_VALUE;
        let max = SHAKE_ELEMENT_MAX_VALUE;
